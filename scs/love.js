...
B.M.B-XMD✨ ᴏᴡɴᴇʀ sᴀʏs ᴍᴏsᴛ ᴏғ ᴜᴘᴅᴀᴛᴇs ᴀʀᴇ ᴀʀᴏᴜɴᴅ ᴛʜᴇ ᴄᴏʀɴᴇʀ... ʏᴏᴜ ᴡɪʟʟ ᴇɴᴊᴏʏ ᴍᴏʀᴇ ᴄᴏᴍᴍᴀɴᴅs ᴀs ʜᴇ ᴀᴅᴅs ᴛʜᴇᴍ...
...
adams({ nomCom: 'channel1',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`tap here to join my second channel https://whatsapp.com/channel/0029VawO6hgF6sn7k3SuVU3z`) 
...
adams({ nomCom: 'b-m-b',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*_𝙱.𝙼.𝙱-𝚇𝙼𝙳✨ is running...... Love it_*`) 
...
adams({ nomCom: 'groupbmb',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`top a link to join our group https://chat.whatsapp.com/JpIXcc3AndB3d9pdK2Cg1I `) 
...
Wanna talk to me?👉 https://wa.me/c/255767862457 👈
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
© *𝙱.𝙼.𝙱 tech *`) 
